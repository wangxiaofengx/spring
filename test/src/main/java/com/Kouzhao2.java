...
public class Kouzhao2 {

    RestTemplate restTemplate = new RestTemplate();

    private static final Logger logger = LoggerFactory.getLogger(Kouzhao2.class);
    ...
    public static void main(String[] args) throws JsonProcessingException {
        Kouzhao2 kouzhao2 = new Kouzhao2();
        ...
        kouzhao2.execute(new String[]{"1007", "1028"}, xinzheng);
